...
fig_angularV = plt.figure(3,figsize=(6,6))
ax_angularV = p3.Axes3D(fig_angularV)


ax_angularV.plot(*np.transpose(b.w_body_hasbun))
ax_angularV.plot(*np.transpose(b.w))

fig_angularVxyz = plt.figure(4,figsize=(6,6))
plt.plot(np.transpose(b.w_body_hasbun[:,0]))
plt.plot(np.transpose(b.w[:,0]))
plt.plot(np.transpose(b.w_body_hasbun[:,1]))
plt.plot(np.transpose(b.w[:,1]))
