...
b.tn=3.0
b.samplerate=800
b.orien = np.array([-np.radians(20),0,0])
b.freq=1
...
b.DrawOption['A_Angular Momentum Trace'] = False
#Draw Angular momentum vector normalized to initial value at t0
b.DrawOption['A_Angular Momentum Vec'] = False
b.DrawOption['A_Angular Velocity Vec'] = False
