...
wp = npzfile['wp']
wz = np.arange(0,N,1)/N/10    #swap wx to wz)
wx = (np.arange(0,N,1)+2)/N /10 
wy = (np.arange(0,N,1)+3) /N/10
Iz = npzfile['Ix']
...
line_ani = animation.FuncAnimation(fig, update_line, list(range(1,N,1)),
