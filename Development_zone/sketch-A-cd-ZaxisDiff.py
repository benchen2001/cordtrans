...
gs.update(left=0.12, bottom=0.15, right=0.95, top=0.90, wspace=0.23, hspace=0.23)
...
diffb4 = [np.arccos(np.dot(b4.cordvec[i,:,9],
                              b4.cordvec[i,:,2]/np.linalg.norm(b4.cordvec[i,:,2]))) for i in range(0,b4.N,1)]
diffindegb4 = np.degrees(diffb4)

ax3.plot(np.linspace(0.0,b3.tn,b3.N/100),diffindegb3[::100])
ax3.locator_params(tight=True, nbins=4)
ax3.text(0.1,0.8,'(c)',fontsize=9,transform=ax3.transAxes)
ax4.plot(np.linspace(0.0,b4.tn,b4.N/100),diffindegb4[::100])
