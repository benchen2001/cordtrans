...
b.freq= 0.001
#b.samplerate=1500
b.orien = np.array([-np.radians(1),0,0])
...
np.savetxt(r'C:\Documents and Settings\user\My Documents\tony\2014\Xelatexfolder\otherstuff\Case_A_f0_1deg_datafile.txt',
...
np.savetxt(r'C:\Documents and Settings\user\My Documents\tony\2014\Xelatexfolder\otherstuff\Case_A_f0_1deg_square_datafile.txt',
